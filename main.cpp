...
const std::string fileArray[NUM_FILES] = { "run_files/file1.txt", "run_files/file2.txt", "run_files/file3.txt", "run_files/file4.txt", "run_files/file5.txt", "run_files/file6.txt"}; // string aray containing the file names
...
{
	std::ifstream ifs; // stream to read in from the files
	std::ofstream ofs; // output stream to write to an output file
